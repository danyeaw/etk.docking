...
from etk_docking import DockItem
...
class TestDockItem(unittest.TestCase):
    ...
    def test_prop_title_tooltip_text(self):
        ...
        self.assertEquals(
            dockitem.props.title_tooltip_text,
            "hello",
            msg=".props attribute did not return expected value",
        )
        self.assertTrue(
