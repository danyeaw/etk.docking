...
class LoadingTestCase(unittest.TestCase):
    def test_serialize(self):
        ...
        paned.add(group)
        item = DockItem(
            title="t", title_tooltip_text="xx", icon_name="icon", stock_id=""
        )
    ...
    def test_deserialize_floating_windows(self):
        ...
        self.assertEquals(
            0.45, main_frames[0].get_children()[0]._items[0].weight_request
        )
